...
def test_FairNN(save_md, save_te, dataname = 'adult', save_dir='../results'):
    
    
    print("load test data from ", save_te)
    X_te = load_nparray(save_te)
    print(X_te.shape)
    print("load FNN model from ", save_md)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'Argument for testing fair NN')
    ...
    save_md = os.path.join(args.result_dir,args.dataname+"_FNN_model.sm")
    test_data = os.path.join(args.result_dir,args.dataname+"_fnn_testX.te")
