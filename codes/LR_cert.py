...
def certify_LR(dataname,save_dir):
    # load test y and z
#     save_path = os.path.join(save_dir,dataname+'_flr_testset.te')
    _,y_te,z_te = load_testdata(save_dir,dataname+'_lr')
    
    # load prediction results
    save_path2 = os.path.join(save_dir,dataname+'_lr_pred.pr')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(description = 'Argument for certifying LR')
