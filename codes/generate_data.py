...
def generate_synthetic_data(plot_data=False,n_samples = 1000,disc_factor = math.pi / 4.0):
    ...
    #n_samples: generate these many data points per class
    #disc_factor: this variable determines the initial discrimination in the data -- decraese it to generate more discrimination
